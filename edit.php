        ...
        <div class="mainContainer">
         ...
         <?php
             if(isset($_GET['message'])){
                echo '<div style="background-color: rgb(248, 4, 98);color: #eee;padding: 15px;border-radius: 10px;font-size: 17px;text-align: center;">'.$_GET['message'].'<a href="edit.php" style="color: green;background-color:#eee;padding: 5px 20px;border-radius: 10px;margin-left: 100px;text-decoration: none;">close</a> </div>';
             }
            ?>
         </div><br>
         <div>
                    ...
                    if(mysqli_num_rows($query) > 0){
                        ...
                        while($row = mysqli_fetch_assoc($query)){
                             ...
                             <tr>
                                 ...
                                 <td>'.$row['date'].'</td>
                                 <td>
                                    <a href="update.php?id='.$itemId.'">Edit</a>
                                 </td>
                                <td>
